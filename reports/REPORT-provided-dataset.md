...
Generated 2026-08-01T18:40:11.322353+00:00 · database `pw` · 5 incident(s) found.
...
Request volume on Jun 21 fell to 126,052 from an expected 232,435, a drop of -45.77%, which is 32x larger than this metric's normal movement. The verdict is global: every segment moved with the population at -43.5%, and no single segment stands apart. The gaming vertical moved -4.0% relative to the population, the news app category -2.5%, country AE -2.1%, country ES +2.0%, and rewarded ad format -1.8%, all within normal spread. This rules out each of those segments as the cause, confirming the decline is population-wide.

<sub>✅ every figure machine-verified against the computed evidence · [full trace of this investigation](https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=a2dc4fe6-1174-46db-9fd8-72fe66252a3c) · narrated by `deepseek-chat`</sub>
...
<sub>✅ every figure machine-verified against the computed evidence · [full trace of this investigation](https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=4b6a44d6-f2b0-441c-8aa2-aa8f4a8c4090) · narrated by `deepseek-chat`</sub>
...
eCPM fell from $2.475 to $2.416, a -2.37% drop that was 5x larger than normal movement. The decline was localized to app category = finance, whose eCPM dropped from $2.470 to $1.613 (-34.7%). Excluding finance, eCPM moved +0.05% against -2.38% for all traffic, fully explaining 98% of the movement. Had finance held baseline, revenue would have been $41.56 higher. App = app_00011 (-32.7%), ad format = interstitial (-4.8%), and native (+4.1%) were ruled out as lesser contributors.

<sub>✅ every figure machine-verified against the computed evidence · [full trace of this investigation](https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=ef353155-255f-4ed8-921e-c4632cf3e491) · narrated by `deepseek-chat`</sub>
...
Fill rate fell from 78.4% to 77.5% (a -1.10% change) between Jun 29–Jun 30, a movement 4x larger than normal. The culprit is country = JP, which dropped from 78.1% to 69.8% (-10.6%), with evidence strength of 32 standard errors. Excluding JP, fill rate actually rose +0.24% versus -0.45% for all traffic, proving JP is responsible, though it explains only 46% of the movement. Within JP, the drop concentrates in device OS version = iOS 18.1 (0.7857 → 0.3943, -49.8%). Ruled out as primary causes: country = JP (relative -10.2%), Android 15 (+9.0%), iPhone 14 (-5.5%), and APAC (-3.2%). Had JP held baseline revenue per request, revenue would have been $4.50 higher.

<sub>✅ every figure machine-verified against the computed evidence · [full trace of this investigation](https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=fa0fdbe3-d553-44d9-ab19-5b97dcc16623) · narrated by `deepseek-chat`</sub>
...
**Run:** https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859

- request volume   Jun 21                 https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=a2dc4fe6-1174-46db-9fd8-72fe66252a3c
- fill rate        Jun 23–Jun 25          https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=821c5830-2563-4389-9f93-6b323ba7ed57
- revenue          Jun 21                 https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=4b6a44d6-f2b0-441c-8aa2-aa8f4a8c4090
- eCPM             Jun 19–Jun 22          https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=ef353155-255f-4ed8-921e-c4632cf3e491
- fill rate        Jun 29–Jun 30          https://langfuse.datagan.site/trace/cf5c520e-d7a8-4f71-9dd0-a3a64fdba859?observation=fa0fdbe3-d553-44d9-ab19-5b97dcc16623
