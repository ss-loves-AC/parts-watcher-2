...
| [`../out/unseen/diagnosis.md`](diagnosis.md) | the prose alone |
| [`../out/unseen/evidence.json`](evidence.json) | every computed number, machine-readable |
| [`../out/unseen/queries.sql`](queries.sql) | the SQL behind every figure |
| [`../out/unseen/trace.txt`](trace.txt) | Langfuse links |
